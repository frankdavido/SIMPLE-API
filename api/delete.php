...
if (strtoupper($_SERVER['REQUEST_METHOD']) !== 'DELETE') {
    ...
    echo json_encode(array('message'=>'Use DELETE REQUEST_METHOD', 'status'=>'error'));
    exit;
}
// get data
...
try {
    /*
     * Form an SQL query with: Where clause
     */
    ...
    /*
     * Prevent the user from deleting all records. Ensure the request must have at least one paramter
     */
    if ($whereClause === " where ") {
        ...
        echo json_encode(array('message'=>'You must provide at least one parameter', 'status'=>'error'));
        exit;
    }
